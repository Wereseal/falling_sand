...
public class BrushSizeDown extends RegularButton {

    private final SimulationWindow simulationWindow;
    public BrushSizeDown(int xPos, int yPos, int width, int height, String name, Texture baseTexture, Texture selectedTexture, SimulationWindow pSimulationWindow) {
