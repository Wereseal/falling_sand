...
public class SimulationSpeedUp extends RegularButton {

    private final SimulationWindow simulationWindow;
    public SimulationSpeedUp(int xPos, int yPos, int width, int height, String name, Texture baseTexture, Texture selectedTexture, SimulationWindow pSimulationWindow) {
